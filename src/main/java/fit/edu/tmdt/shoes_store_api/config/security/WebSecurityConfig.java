...
import fit.edu.tmdt.shoes_store_api.config.token.AuthTokenFilter;
...
//                        .requestMatchers(SecurityConstants.USER_API_PATHS).hasAnyAuthority(SecurityConstants.Role.CLIENT, SecurityConstants.Role.ADMIN)
